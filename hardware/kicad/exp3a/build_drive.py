...
IR=(127,102)
drive=[
  {"lib":"Device:R","ref":"R1","val":"200","x":50.8,"y":102,"nets":{"1":"PWM","2":"OPTO_A"}},
  {"lib":"Isolator:ILD74","ref":"U2","val":"ILD74","x":76.2,"y":102,"unit":1,
     "nets":{"1":"OPTO_A","2":"GND","7":"+15V","8":"OPTO_OUT"}},
  {"lib":"Device:R","ref":"R2","val":"1k","x":99.06,"y":116,"nets":{"1":"OPTO_OUT","2":"GND"}},
  {"lib":"Device:C_Polarized","ref":"C2","val":"22u","x":99.06,"y":80,"nets":{"1":"+15V","2":"GND"}},
  {"lib":"Device:C","ref":"C1","val":"100n","x":111.76,"y":80,"nets":{"1":"+15V","2":"GND"}},
  {"lib":"Driver_FET:IR2110","ref":"U1","val":"IR2110","x":IR[0],"y":IR[1],"unit":1,
     "nets":{"9":"+15V","3":"+15V","13":"GND","2":"GND","10":"OPTO_OUT","12":"OPTO_OUT",
             "11":"GND","1":"LO","5":"GND","6":"+15V"}},
  {"lib":"Diode:1N4007","ref":"D1","val":"1N4007","x":155,"y":102,"nets":{"2":"LO","1":"GATE1"}},
  {"lib":"Device:R","ref":"R3","val":"10","x":170,"y":102,"nets":{"1":"GATE1","2":"GATE"}},
  {"lib":"Device:R","ref":"R4","val":"1k","x":170,"y":120,"nets":{"1":"GATE","2":"GND"}},
  {"lib":"Transistor_FET:IRF540N","ref":"Q1","val":"IRF540N","x":190,"y":104,
     "nets":{"G":"GATE","D":"MOTOR_SW","S":"GND"}},
  {"lib":"Diode:1N4007","ref":"D2","val":"1N4007","x":205,"y":92,"nets":{"1":"+20V","2":"MOTOR_SW"}},
  {"lib":"Motor:Motor_DC","ref":"M1","val":"Motor_DC","x":218,"y":94,"nets":{"1":"+20V","2":"MOTOR_SW"}},
]
ncs=[("Driver_FET:IR2110","U1","7",IR[0],IR[1],0,1),   # HO unused (low-side only)
     ("Driver_FET:IR2110","U1","4",IR[0],IR[1],0,1),
     ("Driver_FET:IR2110","U1","8",IR[0],IR[1],0,1),
     ("Driver_FET:IR2110","U1","14",IR[0],IR[1],0,1)]

if __name__=="__main__":
    build("Drive Circuit  (Exp 3A: PWM -> opto -> IR2110 -> IRF540N -> DC motor)",
          drive, ncs, Path(__file__).parent/"drive_circuit.kicad_sch")
