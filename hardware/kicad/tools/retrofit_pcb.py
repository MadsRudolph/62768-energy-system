#!/usr/bin/env python3
"""HISTORISK - engangs-script koert 10-jun-2026 (stierne refererer den GAMLE
mappestruktur foer boards/-omlaegningen). Bevares som dokumentation af
drive-rettelserne og PCB-klargoeringen. KOER DET IKKE IGEN.
...
FP = {
    ...
    "TO220":  "energy_system:TO-220-3_Vertical_LaserPads",
    "DIP6":   "Package_DIP:DIP-6_W7.62mm_LongPads",
    "DIP8":   "Package_DIP:DIP-8_W7.62mm_LongPads",
    "DIP14":  "Package_DIP:DIP-14_W7.62mm_LongPads",
