...
def main(jsonf, outf):
    ...
    PLACE = {
        ...
        # c2000_feedback (TI-port, 3.3V): 6-kanals front-end. Signalflow venstre->
        # hoejre - 3 spaendingskanaler (deler+zener+cap) oeverst, 3 stroemkanaler
        # (shunt+MCP601) nederst; I3-diffamp + bias/decap i bunden; MCU-headers
        # (J2/J4/J6/J8/J10) langs hoejre kant, skrueterminaler langs venstre.
        # 0 uroutede, 0 DRC, 0 vias, 12 traadbroer.
        "c2000_feedback": {"refs": {
            "J1": (30, 14, 180), "RV11": (46, 14, 0), "RV12": (46, 21, 0), "RV13": (62, 14, 0), "DV1": (78, 14, 0), "CV1": (78, 21, 0),
            "J3": (30, 28, 180), "RV21": (46, 28, 0), "RV22": (46, 35, 0), "RV23": (62, 28, 0), "DV2": (78, 28, 0), "CV2": (78, 35, 0),
            "J5": (30, 42, 180), "RV31": (46, 42, 0), "RV32": (46, 49, 0), "RV33": (62, 42, 0), "DV3": (78, 42, 0), "CV3": (78, 49, 0),
            "J7": (30, 60, 180), "RSH1": (48, 60, 0), "U1": (64, 60, 0), "RF1": (82, 55, 0), "RG1": (82, 63, 0), "CD1": (92, 60, 0),
            "J9": (30, 75, 180), "RSH2": (48, 75, 0), "U2": (64, 75, 0), "RF2": (82, 70, 0), "RG2": (82, 78, 0), "CD2": (92, 75, 0),
            "J11": (30, 90, 180), "RSH3": (48, 90, 0), "U3": (64, 90, 0), "R31": (48, 82, 0), "R33": (48, 98, 0), "R32": (82, 86, 0), "R34": (82, 94, 0),
            "RB1": (96, 86, 0), "RB2": (96, 94, 0), "CB": (64, 100, 0), "CD3": (82, 100, 0),
            "RPWM": (90, 33, 0), "J10": (100, 15, 180), "J8": (100, 27, 180), "J2": (100, 40, 180), "J4": (100, 52, 180), "J6": (100, 65, 180),
        }},
    }
    import os as _os
