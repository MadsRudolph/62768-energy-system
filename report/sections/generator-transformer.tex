...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Generator_Transform/Input+Output_voltage.png}
        \caption*{(a) Input voltage and output voltage}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Generator_Transform/Input+Output_voltage+current.png}
        \caption*{(b) Input voltage, output voltage and input current}
    \end{minipage}
