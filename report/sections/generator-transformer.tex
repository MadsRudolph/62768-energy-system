...
\vspace{0.5cm}
In a real three-phase system, the generator is typically connected in a way where the phase voltages are defined relative to each other, and a separate return path is not explicitly required in the same way. 
