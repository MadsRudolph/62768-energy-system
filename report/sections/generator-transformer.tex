...
However, in the simulation environment, each source must be referenced to a common node to ensure correct numerical behavior and convergence.
\vspace{0.5cm}
...
\end{figure}
The figure shows the simulated output voltage of the rectifier during startup. 
...
\end{figure}
The second figure shows a zoomed view of the steady-state output voltage, where a small ripple is visible. 
