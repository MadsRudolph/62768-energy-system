...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Rectifier_simulink_diagram.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=1\linewidth]{Rectifier_simulation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Rectifier_Ripple.png}
