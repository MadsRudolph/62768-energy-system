...
The inertia resists rapid changes in speed, while the damping represents friction that slows down the system. 
As a result, the system exhibits a dynamic response with a certain time delay.
\\
...
\\
These dynamics are important, as they determine how quickly the motor-generator system reacts to changes in input and form the basis for the subsequent control design.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{report/images/Rectifier/Rectifier_ML.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{report/images/Rectifier/Rectifier_simulink_diagram.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=1\linewidth]{report/images/Rectifier/Rectifier_simulation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{report/images/Rectifier/Rectifier_Ripple.png}
    \caption{Rectifer Ripple}
    \label{fig:Rectifier_sim_ripple}
\end{figure}
\noindent The second figure shows a zoomed view of the steady state output voltage, where a small ripple is visible. 
...
This results in a stable DC voltage suitable for the following stages in the system.
