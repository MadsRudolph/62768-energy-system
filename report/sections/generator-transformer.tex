...
\vspace{0.5cm}
Therefore, the simulation model includes a return path for each phase, which is a modeling requirement rather than a physical necessity in the real system. The KiCad model earlier shows the system more effectively in reality.
