...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{images/Feedback-circuit/Feedback circuit.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/Feedback-circuit/Feedback circuit hulprint.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/Feedback-circuit/Feedback_Output.png}
\caption{Oscilloscope measurement of the feedback output. - Project 3 report, 62783}
\label{fig:feedback_output}
\end{figure}
