...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/Buck/Buck_Reference.png}
...
V_{out} = D \cdot V_{in},
\]
meaning that a duty cycle of approximately 33\% is required to obtain 5 V. Therefore, a fixed duty cycle of 33\% is implemented using a self designed PWM generator (see Figure~\ref{fig:PWM_Buck}).\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/Buck/Buck_with_PWM.png}
